...
//
//   // REQUESTED , ACCEPTED , REJECTED , ON_THE_TIME , REFUSED , FINISHED
//
//   if (orderStatus == "REQUESTED") {
//     print('Case 1');
//   } else if (orderStatus == "ACCEPTED") {
//     print('Case 2');
//   } else if (orderStatus == "ON_THE_TIME") {
//     print('Case 3');
//   } else if (orderStatus == "FINISHED") {
//     print('Case 4');
//   } else {
...
//   String rate = "4.5";
//
//   if (orderStatus == "REQUESTED" && rate.isEmpty) {
//     print('Show Rate Button');
//   } else {
//     print('Hide Rate Button');
//   }
...
// //  Array , List
//  var names = ["Amir", "Ahmed", "Mohammed", "Ali"];
//  List<String> groubTwoNames = ["Hamdy", "Hussein", "Osama", "Aziz"];
//
//  names.add("Moaz");
//  names.add("Salah");
//  names.addAll(groubTwoNames);
//
//   print(names);
//
//   print('Name is ${names[6]}');
//
//   print('Name ${names.getRange(2, 5)}');
//
//   for (var name in names) {
//     print('Mr. $name');
//   }
...
//   names.add("Hamdy");
//
//   names.removeWhere((element) => element == "Hamdy");
//   print(names);
//
//
//   print('--------------------');
...
//
//
//   String phoneNumber = " +20112-624-8835 ";
//   phoneNumber = phoneNumber.replaceAll(" ", "").replaceAll("-", "");
//   if (phoneNumber.startsWith("00")) {
